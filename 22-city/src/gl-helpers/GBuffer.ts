...
class GBuffer {
    ...
    setForLightingPass(): void {
        ...
        gl.bindTexture(gl.TEXTURE_2D, this.colorTextures[GBUFFER_TEXTURE_TYPE.GBUFFER_TEXTURE_TYPE_DIFFUSE]);
    ...
    output2Screen(): void {
        ...
        gl.readBuffer(gl.COLOR_ATTACHMENT0 + GBUFFER_TEXTURE_TYPE.GBUFFER_TEXTURE_TYPE_DIFFUSE);
