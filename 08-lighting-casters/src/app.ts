...
cubeShader.uniform1f('light.constant', 1.0);
cubeShader.uniform1f('light.linear', 0.09);
cubeShader.uniform1f('light.quadratic', 0.032);
...
new RenderLooper(msdt => {
    ...
    cubeShader.uniform3fv('light.position', orbitCamera.position);
    cubeShader.uniform3fv('light.direction', orbitCamera.front);
    cubeShader.uniform1f('light.cutOff', Math.cos(getRadian(15)));
    cubeShader.uniform1f('light.outCutOff', Math.cos(getRadian(20)));
    // cubeShader.uniform3fv('light.direction', new Float32Array([-0.2, -1.0, -0.3]));
